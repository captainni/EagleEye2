<template>
  <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
    <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4 items-end">
      ...
      <div>
        <label for="policyRelevance" class="block text-sm font-medium text-gray-700 mb-1">相关度</label>
        <select
          id="policyRelevance"
...
import { policyImportanceOptions as importanceOptions, policyRelevanceOptions as relevanceOptions } from '@/utils/defaultData';
